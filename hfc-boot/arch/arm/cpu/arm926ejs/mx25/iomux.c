 ...
 */
enum iomux_reg_addr {
	IOMUXGPR = IMX_IOPADMUX_BASE,
	/*!< General purpose */
	IOMUXSW_MUX_CTL = IMX_IOPADMUX_BASE + 0x008,
	/*!< MUX control */
	IOMUXSW_MUX_END = IMX_IOPADMUX_BASE + 0x228,
	/*!< last MUX control register */
	IOMUXSW_PAD_CTL = IMX_IOPADMUX_BASE + 0x22C,
	/*!< Pad control */
	IOMUXSW_PAD_END = IMX_IOPADMUX_BASE + 0x414,
	/*!< last Pad control register */
	IOMUXSW_INPUT_CTL = IMX_IOPADMUX_BASE + 0x460,
	/*!< input select register */
	IOMUXSW_INPUT_END = IMX_IOPADMUX_BASE + 0x580,
