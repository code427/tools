...
#define CCM_MCR			(IMX_CCM_BASE + 0x64)
#define CCM_CGR0		(IMX_CCM_BASE + 0x0C)
#define CCM_CGR1		(IMX_CCM_BASE + 0x10)
#define CCM_CGR2		(IMX_CCM_BASE + 0x14)
#define CCM_PCDR0       (IMX_CCM_BASE + 0x18)
#define CCM_PCDR1       (IMX_CCM_BASE + 0x1C)
#define CCM_PCDR2       (IMX_CCM_BASE + 0x20)
#define CCM_PCDR3       (IMX_CCM_BASE + 0x24)
...
#define MX25_GPTCR          	0x00
#define MX25_GPTPR          	0x04
#define MX25_GPTSR          	0x08
#define MX25_GPTIR          	0x0C
#define MX25_GPTOCR1            0x10
#define MX25_GPTOCR2            0x14
#define MX25_GPTOCR3            0x18
#define MX25_GPTICR1            0x1C
#define MX25_GPTICR2            0x20
#define MX25_GPTCNT         	0x24
