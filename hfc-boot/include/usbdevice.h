...
struct usb_device_instance {
	...
	int (*hid_recv_setup)(struct usb_device_request *request, struct urb *urb);
...
struct usb_hid_report_descriptor *usbd_get_hid_report(void);
struct usb_device_descriptor *usbd_device_device_descriptor(
